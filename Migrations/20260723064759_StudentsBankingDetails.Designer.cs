...
namespace ClockItSystem.Migrations
{
    ...
    [Migration("20260723064759_StudentsBankingDetails")]
    partial class StudentsBankingDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClockItSystem.Models.AccountType", b =>
                {
            ...
            modelBuilder.Entity("ClockItSystem.Models.Bank", b =>
                {
            ...
            modelBuilder.Entity("ClockItSystem.Models.BankBranch", b =>
                {
            ...
            modelBuilder.Entity("ClockItSystem.Models.ViewModels.ReportResultViewModel", b =>
                {
                    b.Property<DateTime?>("AttendanceDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("ReportResultViewModel");
                });
            ...
            modelBuilder.Entity("ClockItSystem.Models.AttendanceApproval", b =>
                {
                    b.HasOne("ClockItSystem.Models.AttendanceRecord", "AttendanceRecord")
                        .WithOne("AttendanceApproval")
                        .HasForeignKey("ClockItSystem.Models.AttendanceApproval", "AttendanceRecordId")
            ...
            modelBuilder.Entity("ClockItSystem.Models.BankBranch", b =>
                {
                    b.HasOne("ClockItSystem.Models.Bank", "Bank")
            ...
            modelBuilder.Entity("ClockItSystem.Models.Student", b =>
                {
                    b.HasOne("ClockItSystem.Models.AccountType", "AccountType")
                        .WithMany("Students")
                        .HasForeignKey("AccountTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ClockItSystem.Models.BankBranch", "BankBranch")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("ClockItSystem.Models.AttendanceRecord", b =>
                {
                    b.Navigation("AttendanceApproval");
                });
